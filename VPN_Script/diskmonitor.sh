...
#LINESOC_KEY="mi6GxeQXqPxLATRvus3aj6WwBMq2x3lSA3KB1bAcsm0"
...
if [ $DISK_USAGE -gt $THRESHOLD ]; then
    ...
    echo $MESSAGE
    curl -X POST -H 'Authorization: Bearer mi6GxeQXqPxLATRvus3aj6WwBMq2x3lSA3KB1bAcsm0' -F "message=$MESSAGE" https://notify-api.line.me/api/noti$
fi
